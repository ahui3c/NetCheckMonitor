...
try {
    ...
    $ok = $main.Text -eq 'NetCheckMonitor Network Monitor' -and
        $mainText.Contains('Start') -and $mainText.Contains('Download PDF Report') -and $mainText.Contains('About') -and $mainText.Contains('Settings') -and $mainText.Contains('v0.9.17') -and
        $about.Text -eq 'About NetCheckMonitor' -and $aboutText.Contains('Version 0.9.17') -and $aboutText.Contains('Scheduled monitoring') -and $aboutText.Contains('廖阿輝') -and $aboutText.Contains('Website:') -and $aboutText.Contains('https://ahui3c.com') -and $aboutText.Contains('GitHub project:') -and $aboutText.Contains('https://github.com/ahui3c/NetCheckMonitor') -and $aboutText.Contains('Online Update') -and
