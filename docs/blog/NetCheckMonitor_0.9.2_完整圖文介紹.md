...
測試進行中可以按下「產生即時報表」，先查看目前累積的結果，不必結束整個監控。正式結束時則可以使用「結束並產生報表」，保存最後資料並建立完整報告。
...
NetCheckMonitor 同時提供繁體中文與英文介面。程式會依照 Windows 顯示語言自動選擇：

- 繁體中文 Windows：使用繁體中文
- 英文 Windows：使用英文
- 簡體中文或其他未支援語言：預設使用英文

使用者不需要額外下載語言包，也不用在第一次啟動時設定語言。報表內容也會配合目前介面語言產生。
