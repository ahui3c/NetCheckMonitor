...
- 修正安裝於 Program Files 後，一般權限啟動或自動監控可能因設定檔無法寫入而中止。
- 安裝版設定自動改存使用者 AppData；可攜版仍維持設定檔放在程式旁。
- 主設定、Google Drive、Gmail 與 Session 檔案會自動遷移到安全位置。

完整內容請參閱 [0.9.18 更新說明](docs/RELEASE_NOTES_0.9.18.md)。
